<template>
  <footer>
    <div class="flex items-center mx-40 grid place-items-center my-20">
      <div>
    ...
    <div class="grid place-items-center my-20 w-full ">
      <div class="flex items-center gap-10">
        <a href="https://www.facebook.com/ardijancuri/" class="bg-secondary h-12 w-12 grid place-items-center rounded-md">
          <img src="../assets/images/social/fb.svg" alt="">
        </a>
        <a href="https://www.instagram.com/brance_design/" class="bg-secondary h-12 w-12 grid place-items-center rounded-md">
          <img src="../assets/images/social/instagram.svg" alt="">
        </a>
        <a href="https://mobile.twitter.com/ardcuri" class="bg-secondary h-12 w-12 grid place-items-center rounded-md">
